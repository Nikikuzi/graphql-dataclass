...
class EnterpriseMembershipType(Enum):
    """
    EnterpriseMembershipType - The possible values we have for filtering Platform::Objects::User#enterprises.
...
class EnterpriseOrderField(Enum):
    """
    EnterpriseOrderField - Properties by which enterprise connections can be ordered.
...
class MergeStateStatus(Enum):
    """
    MergeStateStatus - Detailed status information about a pull request merge.
...
class OrganizationInvitationSource(Enum):
    """
    OrganizationInvitationSource - The possible organization invitation sources.
...
class RepositoryRuleOrderField(Enum):
    """
    RepositoryRuleOrderField - Properties by which repository rule connections can be ordered.
...
class RepositoryRulesetBypassActorBypassMode(Enum):
    """
    RepositoryRulesetBypassActorBypassMode - The bypass mode for a specific actor on a ruleset.
...
class SponsorAndLifetimeValueOrderField(Enum):
    """
    SponsorAndLifetimeValueOrderField - Properties by which sponsor and lifetime value connections can be ordered.
...
class SponsorshipPaymentSource(Enum):
    """
    SponsorshipPaymentSource - How payment was made for funding a GitHub Sponsors sponsorship.
...
class TeamReviewAssignmentAlgorithm(Enum):
    """
    TeamReviewAssignmentAlgorithm - The possible team review assignment algorithms
